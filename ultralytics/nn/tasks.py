...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, DSConv, Focus,
                 ...
                 C3_DLKA, C2f_DLKA, CSPStage, SPDConv, RepBlock, C3_EMBC, C2f_EMBC, SPPF_LSKA,SPPF_EMA, C3_DAttention, C2f_DAttention,
                 ...
                 C3_SWC, C2f_SWC, C3_iRMB, iRMB_F, C3_iRMB_Cascaded, iRMB_F_Cascaded, C3_iRMB_DRB, iRMB_F_DRB, C3_iRMB_SWC, iRMB_F_SWC,
                 C3_VSS, C2f_VSS, C3_LVMB, Mamba_F, RepNCSPELAN4, DBBNCSPELAN4, OREPANCSPELAN4, DRBNCSPELAN4, ADown, V7DownSampling,
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, C2f_Faster, C2f_ODConv, C2f_Faster_EMA, C2f_DBB,
                     ...
                     C3_iRMB, iRMB_F, C3_iRMB_Cascaded, iRMB_F_Cascaded, C3_iRMB_DRB, iRMB_F_DRB, C3_iRMB_SWC, iRMB_F_SWC,
                     C3_VSS, C2f_VSS, C3_LVMB, Mamba_F, C3_DynamicConv, C2f_DynamicConv, C3_GhostDynamicConv, C2f_GhostDynamicConv,
